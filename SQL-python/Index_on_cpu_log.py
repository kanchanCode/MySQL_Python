...
@Title : Python script to connect cpu_data Database with python and create index.
'''  
...
if __name__=="__main__":
    ...
    #create database
    create_index_query="""CREATE INDEX 
    cpu_log_user_name_idx 
    ON cpu_log(user_name);
    """

    select_query="""
    select Roll_no,user_name,technology 
    FROM cpu_log 
    WHERE user_name='you@example.com';
    """
    ...
    results=execute_query(connection,create_index_query)
